...
const ACHIEVEMENTS = {
    ...
    ttt: { icon: '⭕', name: 'stalemate', desc: 'drew with a machine that cannot lose' },
    rps: { icon: '✌️', name: 'unpredictable', desc: 'won five throws against the pattern reader' },
    hangman: { icon: '🪢', name: 'wordsmith', desc: 'guessed the word before the drawing finished' },
    simon: { icon: '🎵', name: 'perfect pitch', desc: 'got eight in a row in simon' },
    g2048: { icon: '🔢', name: 'two thousand and forty eight', desc: 'made the tile' },
    tetris: { icon: '🧱', name: 'ten lines', desc: 'cleared ten in tetris' },
    breakout: { icon: '🧨', name: 'wall gone', desc: 'cleared the wall in breakout' },
    whack: { icon: '🔨', name: 'quick hands', desc: 'hit twenty trolls in thirty seconds' },
    adopted: { icon: '🥚', name: 'responsible', desc: 'adopted something' },
    petted: { icon: '💗', name: 'attentive', desc: 'patted it fifty times' },
    neko: { icon: '🐈', name: 'oneko', desc: 'let the cat out' },
    blinkie: { icon: '✨', name: 'blinkie', desc: 'made a 150x31 blinkie and kept it' },
    stamps: { icon: '📮', name: 'philatelist', desc: 'found the stamp shelf' },
    awards: { icon: '🏆', name: 'unaccredited', desc: 'read the awards this site gave itself' },
    directory: { icon: '🗂️', name: 'sorted by hand', desc: 'opened the directory' },
    scandisk: { icon: '🩺', name: 'surface scan', desc: 'ran scandisk to the end' },
    setup: { icon: '⏳', name: 'four minutes remaining', desc: 'tried to cancel setup' },
    ram: { icon: '💾', name: 'ninety nine percent', desc: 'tried to download more ram' },
    virus: { icon: '🦠', name: 'clean bill', desc: 'scanned for viruses that were never there' },
    hunter2: { icon: '🔑', name: '*******', desc: 'typed the password everyone can see' },
    soundboard: { icon: '🔊', name: 'the whole scheme', desc: 'played with the sound board' },
    moon: { icon: '🌙', name: 'lunatic', desc: 'checked the moon' },
    biorhythm: { icon: '📈', name: 'pseudoscience', desc: 'plotted your biorhythm' },
    love: { icon: '💘', name: 'a hash of two names', desc: 'used the love calculator' },
    cowsay: { icon: '🐄', name: 'moo', desc: 'copied a cow' },
    nat20: { icon: '🎲', name: 'natural twenty', desc: 'rolled a 20 on a d20' },
    surprise: { icon: '🎁', name: 'surprise me', desc: 'let the site pick' },
    rated: { icon: '⭐', name: 'critic', desc: 'rated this site' },
    scroller: { icon: '📜', name: 'window.status', desc: 'brought back the status bar scroller' },
    trail: { icon: '🌈', name: 'cursor trail', desc: 'turned on the trail' },
...
const SHORTCUTS = [
    ...
    ['/', 'find in the document on top'],
    ['alt + ← / →', "back and forward — the browser's own, left alone"],
