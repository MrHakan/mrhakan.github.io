...
// ===================================================================
// defrag.exe lives in defrag.js now — it grew a real disk underneath
// it (the files this page actually downloaded, at the sizes they
// actually weigh) and stopped fitting in with the small toys.
// ===================================================================
...
function siteSearchIndex() {
    return [
        ...
        ['tic tac toe', 'game', () => openTicTacToe(), 'noughts crosses xo minimax unbeatable'],
        ['rock paper scissors', 'game', () => openRPS(), 'roshambo throw hand ai pattern'],
        ['hangman', 'game', () => openHangman(), 'word guess letters gallows'],
        ['simon', 'game', () => openSimon(), 'memory colours sequence tones'],
        ['2048', 'game', () => open2048(), 'tiles slide merge puzzle numbers'],
        ['tetris', 'game', () => openTetris(), 'blocks lines rotate tetromino'],
        ['breakout', 'game', () => openBreakout(), 'bricks paddle ball arkanoid'],
        ['whack a troll', 'game', () => openWhack(), 'mole hammer reflex speed'],
        ['adopt.exe', 'toy', () => openPet(), 'pet tamagotchi adoptable virtual creature feed'],
        ['oneko', 'toy', () => toggleNeko(), 'cat cursor chase follow neko'],
        ['blinkie maker', 'toy', () => openBlinkieMaker(), 'gif badge 150x20 generator graphics'],
        ['stamps', 'toy', () => openStampShelf(), 'stamp shelf 99x56 collection graphics'],
        ['awards', 'document', () => openAwards(), 'cool site of the day badge prize'],
        ['directory', 'document', () => openDirectory(), 'yahoo categories links sorted by hand'],
        ['scandisk', 'program', () => openScanDisk(), 'disk surface scan clusters errors'],
        ['setup', 'program', () => openSetup(), 'install wizard progress estimate'],
        ['download more ram', 'program', () => openMoreRam(), 'memory joke 99 percent'],
        ['antivirus 98', 'program', () => openVirusScan(), 'virus scan threats bonzi clippy'],
        ['enter network password', 'program', () => openNetworkPassword(), 'login dialup hunter2 microsoft networking'],
        ['sound board', 'toy', () => openSoundBoard(), 'sounds effects ding error startup'],
        ['moon.exe', 'toy', () => openMoon(), 'moon phase lunar almanac'],
        ['world clock', 'toy', () => openWorldClock(), 'timezones time cities utc'],
        ['biorhythm', 'toy', () => openBiorhythm(), 'physical emotional intellectual cycles pseudoscience'],
        ['love calculator', 'toy', () => openLoveCalc(), 'names percentage compatibility'],
        ['cowsay', 'toy', () => openCowsay(), 'ascii art cow tux speech bubble'],
        ['dice', 'toy', () => openDice(), 'd20 roll coin flip random'],
        ['surprise me', 'toy', () => surpriseMe(), 'random page shuffle anything'],
        ['rate this site', 'toy', () => openRating(), 'stars five rating review'],
        ['status bar scroller', 'toy', () => toggleStatusScroller(), 'window.status marquee crawl'],
        ['cursor trail', 'toy', () => toggleCursorTrail(), 'mouse rainbow dots follow'],
